...
@section('content')
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Sub Categories Page</h4>
                <div class="card">
                    <div class="card-header">
                        <div class="head-label">
                            <h4 class="card-title">@lang('SubCategories')</h4>
                        </div>
...
<script type="text/javascript">
        var url = "{{url(app()->getLocale().'/sub-categories')}}/";
        var oTable = $('#myTable').DataTable({
              processing: true,
              serverSide: true,
               "order": [[1, 'asc']],
              ajax: "{{ route('sub-categories.indexTable') }}",
              'columnDefs': [
                {
                    "targets": 1,
                    "visible": false
          ...
          $(document).ready(function () {
            $(document).on('click', '.edit_btn', function (event) {
                ...
                $('#edit_category_uuid').val(button.data('category_uuid'));
