                           ...
                           <div class="row">
                               ...
                               <div class="col-12">
                                   <div class="form-group">
                                       <label for="image_{{$key}}">@lang('image') @lang($value)</label>
                                       <input type="file" class="form-control"
                                              placeholder="@lang('image') @lang($value)"
                                              name="image_{{$key}}" id="image_{{$key}}">
         ...
         <div class="modal-body">
             <form action="" id="edit_form" method="POST"
                 ...
                 <div class="row">
                    @foreach(locales() as $key => $value)
                    <div class="col-12">
                        <label for="icon">@lang('image_'.$key)</label>
                        <div class="form-group">
...
<script type="text/javascript">
        var url = "{{url(app()->getLocale().'/Ads')}}/";

        var oTable = $('#myTable').DataTable({
              processing: true,
              serverSide: true,
               "order": [[1, 'asc']],
              ajax: "{{ route('Ads.indexTable') }}",
              'columnDefs': [
                {
                    "targets": 1,
                    "visible": false
            ...
            "oLanguage": {
              ...
              columns: [
                ...
                {
                    "render": function (data, type, full, meta) {
                        return `<td><div class="handle"><img width="50" height="50" src="` + full.image_translate + `" class="avatar avatar-sm me-3" alt="user1"></div></td>`
                    }
                },
